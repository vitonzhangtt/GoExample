...
import "os"
/*
1. A panic typically means something went unexpectedly wrong. 
...
/*
2. We’ll use panic throughout this site to check for unexpected errors. 
	This is the only program on the site designed to panic.
*/
	panic("a problem")
	
/*
3. A common use of panic is to abort if a function returns an error value 
...
/*
4. Note that unlike some languages which use exceptions for handling of many errors, 
