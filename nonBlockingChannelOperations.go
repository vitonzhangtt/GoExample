...
/*
1. Basic sends and receives on channels are blocking. 
...
// If not it will immediately take the default case.	
	...
	default:	
		fmt.Println("no messsage received")
	}

// A non-blocking send works similarly. Here msg cannot be 
// sent to the messages channel, because the channel has 
// no buffer and there is no receiver.
	msg := "hi"
	select {
	case messages <- msg:
